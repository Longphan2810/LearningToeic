  ...
  <path fill-rule="evenodd"
		...
		<div class=" col-11">
			<div class="main-panel content">
				...
				<div
					class="d-flex justify-content-center background1  border-bottom  border-dark"
					id="login">
					<jsp:include page="Login.jsp"></jsp:include>
				</div>
				<div
					class="d-flex justify-content-center background2  border-bottom  border-dark"
					id="register">
				...
				<div class="border-bottom" id="footer">
					...
					<div class="d-flex">
						<div class="col-6">
							<img style="width: 100%; height: 80vh" alt=""
								src="./assets/image/img-mail.png">
						</div>
						<form class="col-6 bg-light">
							<h4 class="m-3 text-success">GET IN TOUCH</h4>
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label m-2">Name</label>
								<input type="email" class="form-control" id="exampleInputEmail1"
									aria-describedby="emailHelp">

							</div>
							<div class="mb-3">
								<label for="exampleInputPassword1" class="form-label m-2">Email</label>
								<input type="text" class="form-control"
									id="exampleInputPassword1">
							</div>
							<div class="mb-3">
								<label for="exampleInputPassword1" class="form-label m-2">Subject</label>
								<input type="text" class="form-control"
									id="exampleInputPassword1">
							</div>
							...
							<button class="btn btn-primary m-5">Sen Message</button>
						</form>
					</div>
